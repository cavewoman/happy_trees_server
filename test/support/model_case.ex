defmodule HappyTreesServer.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import HappyTreesServer.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&HappyTreesServer.ErrorHelpers.translate_error/1)
